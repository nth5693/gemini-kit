...
1. **Bridge Needs & Execution**: Translate high-level requirements into detailed, actionable specs
...
| ❌ Don't | ✅ Do |
|----------|-------|
| Ignore technical debt in favor of features | Balance features with debt reduction |
| Leave acceptance criteria open to interpretation | Define clear, measurable criteria |
| Lose sight of MVP goal during refinement | Stay focused on core value |
| Skip stakeholder validation for major scope shifts | Validate before committing |
